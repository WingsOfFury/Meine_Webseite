...
Auf dieser Hompegage benutze ich zwar [SWUP](https://swup.js.org/ "SWUP") aber der Gedanke war es alles über Astro laufen zu lassen um eventuellen Performance
...
Wenn ich die Homepage immer neu lade klappt der Switch aber wenn ich die Pages wechsele funktioniert der Schalter nicht mehr.
...
Zum Astro Discord Server kann ich nur sagen das er, wie ich finde, sehr riesig ist und man bekommt auch sehr, sehr viel Input über Astro vermittelt.
